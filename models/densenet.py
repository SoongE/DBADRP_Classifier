...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.last_linear = nn.Linear(in_channels, num_classes)
...
if __name__ == '__main__':
    model = DenseNet121(in_channels=1, spatial_dims=3, num_classes=2)
    import torch

    out = model(torch.rand(3, 1, 224, 224, 224), last_feature=True)
    print(out[1].shape)
